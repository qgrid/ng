...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__templates_body_cell_reference_edit__ = __webpack_require__(132);
...
function Setup(qgridThemeProvider) {
	qgridThemeProvider.register('material', function (theme) {
		theme.put('qgrid.plugin.progress.tpl.html', __webpack_require__(170));

		theme.put('qgrid.body.cell.text.edit.tpl.html', __webpack_require__(63));
		theme.put('qgrid.body.cell.text-area.edit.tpl.html', __webpack_require__(152));
		theme.put('qgrid.body.cell.bool.edit.tpl.html', __webpack_require__(138));
		theme.put('qgrid.body.cell.date.edit.tpl.html', __webpack_require__(140));
		theme.put('qgrid.body.cell.number.edit.tpl.html', __webpack_require__(146));
		theme.put('qgrid.body.cell.array.tpl.html', __webpack_require__(136));
		theme.put('qgrid.body.cell.array.edit.tpl.html', __webpack_require__(135));
		theme.put('qgrid.body.cell.password.edit.tpl.html', __webpack_require__(147));
		theme.put('qgrid.body.cell.bool.tpl.html', __webpack_require__(139));
		theme.put('qgrid.body.cell.select.tpl.html', __webpack_require__(151));
		theme.put('qgrid.body.cell.row-indicator.tpl.html', __webpack_require__(150));
		theme.put('qgrid.body.cell.url.tpl.html', __webpack_require__(154));
		theme.put('qgrid.body.cell.url.edit.tpl.html', __webpack_require__(153));
		theme.put('qgrid.body.cell.email.tpl.html', __webpack_require__(143));
		theme.put('qgrid.body.cell.email.edit.tpl.html', __webpack_require__(142));
		theme.put('qgrid.body.cell.file.tpl.html', __webpack_require__(144));
		theme.put('qgrid.body.cell.file.edit.tpl.html', __webpack_require__(62));
		theme.put('qgrid.body.cell.image.tpl.html', __webpack_require__(145));
		theme.put('qgrid.body.cell.image.edit.tpl.html', __webpack_require__(62));
		theme.put('qgrid.body.cell.reference.tpl.html', __webpack_require__(149));
		theme.put('qgrid.body.cell.reference.edit.tpl.html', __webpack_require__(148));
		theme.put('qgrid.body.cell.dropdown.edit.tpl.html', __webpack_require__(141));
		theme.put('qgrid.body.cell.autocomplete.edit.tpl.html', __webpack_require__(137));
		...
		theme.put('qgrid.head.cell.pivot.tpl.html', __webpack_require__(160));
		theme.put('qgrid.head.cell.select.tpl.html', __webpack_require__(161));

		theme.put('qgrid.form.cell.text.edit.tpl.html', __webpack_require__(64));
		theme.put('qgrid.form.cell.number.edit.tpl.html', __webpack_require__(157));
		theme.put('qgrid.form.cell.date.edit.tpl.html', __webpack_require__(156));
		theme.put('qgrid.form.cell.bool.edit.tpl.html', __webpack_require__(155));
		theme.put('qgrid.form.cell.reference.edit.tpl.html', __webpack_require__(158));
		theme.put('qgrid.form.cell.id.edit.tpl.html', __webpack_require__(64));
		theme.put('qgrid.form.cell.url.edit.tpl.html', __webpack_require__(159));

		theme.put('qgrid.toolbar.top.tpl.html', __webpack_require__(173));
		theme.put('qgrid.plugin.column-chooser.tpl.html', __webpack_require__(162));
		theme.put('qgrid.plugin.column-filter-panel.tpl.html', __webpack_require__(163));
		theme.put('qgrid.plugin.edit-form.tpl.html', __webpack_require__(164));
		theme.put('qgrid.plugin.edit-form-panel.tpl.html', __webpack_require__(165));
		theme.put('qgrid.plugin.popup-panel.tpl.html', __webpack_require__(169));
		theme.put('qgrid.plugin.group-bar.tpl.html', __webpack_require__(166));
		theme.put('qgrid.plugin.sort-bar.tpl.html', __webpack_require__(172));
		theme.put('qgrid.plugin.pivot-bar.tpl.html', __webpack_require__(168));
		theme.put('qgrid.plugin.selection-bar.tpl.html', __webpack_require__(171));
		theme.put('qgrid.plugin.pager.tpl.html', __webpack_require__(167));
	});
}
