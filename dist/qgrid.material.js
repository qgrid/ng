...
function Setup(qgridThemeProvider) {
	qgridThemeProvider.register('material', function (theme) {
		theme.put('qgrid.plugin.progress.tpl.html', __webpack_require__(145));

		theme.put('qgrid.body.cell.text.edit.tpl.html', __webpack_require__(136));
		theme.put('qgrid.body.cell.text-area.edit.tpl.html', __webpack_require__(135));
		theme.put('qgrid.body.cell.bool.edit.tpl.html', __webpack_require__(128));
		theme.put('qgrid.body.cell.date.edit.tpl.html', __webpack_require__(130));
		theme.put('qgrid.body.cell.number.edit.tpl.html', __webpack_require__(131));
		theme.put('qgrid.body.cell.array.tpl.html', __webpack_require__(127));
		theme.put('qgrid.body.cell.array.edit.tpl.html', __webpack_require__(126));
		theme.put('qgrid.body.cell.password.edit.tpl.html', __webpack_require__(132));
		theme.put('qgrid.body.cell.bool.tpl.html', __webpack_require__(129));
		theme.put('qgrid.body.cell.select.tpl.html', __webpack_require__(134));
		theme.put('qgrid.body.cell.row-indicator.tpl.html', __webpack_require__(133));
		...
		theme.put('qgrid.head.cell.pivot.tpl.html', __webpack_require__(137));
		theme.put('qgrid.head.cell.select.tpl.html', __webpack_require__(138));

		theme.put('qgrid.toolbar.top.tpl.html', __webpack_require__(148));
		theme.put('qgrid.plugin.column-chooser.tpl.html', __webpack_require__(139));
		theme.put('qgrid.plugin.column-filter-panel.tpl.html', __webpack_require__(140));
		theme.put('qgrid.plugin.popup-panel.tpl.html', __webpack_require__(144));
		theme.put('qgrid.plugin.group-bar.tpl.html', __webpack_require__(141));
		theme.put('qgrid.plugin.sort-bar.tpl.html', __webpack_require__(147));
		theme.put('qgrid.plugin.pivot-bar.tpl.html', __webpack_require__(143));
		theme.put('qgrid.plugin.selection-bar.tpl.html', __webpack_require__(146));
		theme.put('qgrid.plugin.pager.tpl.html', __webpack_require__(142));
	});
}
